...
def map_reduce_and_summarize(plain_text):
    if plain_text:
        ...
        map_prompt = """
        Rewrite the following text for simplicity, but make sure to keep the key terms and concepts introduced: 
        "{text}"
        SUMMARY:
        """
        ...
        combine_prompt = """
        Take the following text delimited by triple backquotes and return the text in bullet points.
        '''{text}'''
        MAIN POINTS:
        """
